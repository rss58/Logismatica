 ...
 */
public class JOptionMoverPerosna_Grupo extends java.awt.Dialog implements ActionListener
{
     ...
     */
    public JOptionMoverPerosna_Grupo(java.awt.Frame parent, boolean modal, Nodo raiz, String seleccionGrupo, String SeleccionPersonas[])
    {
        super(parent, modal);
        initComponents();
        ...
        System.out.println("grupo: " + seleccionGrupo);

        Nodo aux = raiz;

        while (aux != null)
        {
            if (!aux.getEtq().equals(seleccionGrupo))
            {
    ...
    private void initComponents()
    {
        ...
        btnMover.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jLInformacion.setText("Grupo(s) disponibles");

        btnRegresar.setBackground(new java.awt.Color(0, 0, 0));
        btnRegresar.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        btnRegresar.setForeground(new java.awt.Color(255, 255, 255));
        btnRegresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/izquierda.png"))); // NOI18N
        ...
        jLabelAlert.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelAlert.setText("¡SELECCIONE SOLO UNO!");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabelAlert, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    {//GEN-HEADEREND:event_btnMoverActionPerformed
        difuminadoSalir();
        AlertaAlMoverGente mover = new AlertaAlMoverGente(this.paren, true, SeleccionPersonas, s[0]);
        mover.setVisible(true);

        if (mover.isConfirmarMov())
        {
            mover.getNombreMovido();
    ...
    public final void creaIzquierda(String text)
    {
