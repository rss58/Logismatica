 ...
 */
public final class JOptionEliminarGente extends java.awt.Dialog implements ActionListener
{
     ...
     * @param raiz
     */
    public JOptionEliminarGente(java.awt.Frame parent, boolean modal, Nodo raiz)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLInformacion.setText("Perona(s) a eliminar");
    ...
    {//GEN-HEADEREND:event_btnEliminarActionPerformed
        ...
        {
            AlertaAlEliminarGente a = new AlertaAlEliminarGente(this.paren, true, raiz, s[i]);
            a.setVisible(true);
            if (a.isConfirmarEli())
            {
