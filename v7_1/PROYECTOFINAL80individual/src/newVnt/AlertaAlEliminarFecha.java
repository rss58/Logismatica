 ...
 */
public class AlertaAlEliminarFecha extends java.awt.Dialog
{
     ...
     * @param modal
     * @param raiz
     * @param fechaAEliminar
     */
    public AlertaAlEliminarFecha(java.awt.Frame parent, boolean modal, Nodo raiz, String fechaAEliminar)
    {
        super(parent, modal);
        initComponents();
        this.raiz = raiz;
        this.nombreAELiminar = fechaAEliminar;

        Nodo mostrar = busca(raiz, fechaAEliminar);

        txtMuestaDatos.setText(mostrarDatosGente(mostrar));
    }
    ...
    public static String mostrarDatosGente(Nodo r)
    {
        String nom = "";
        Nodo aux = r;
        int nivel = 0;
        
        nom += "Se eliminara esta fecha: " + r.getEtq();
        if (aux != null)
        {
