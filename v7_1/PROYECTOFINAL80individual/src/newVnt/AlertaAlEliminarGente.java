 ...
 */
public class AlertaAlEliminarGente extends java.awt.Dialog
{
     ...
     */
    public AlertaAlEliminarGente(java.awt.Frame parent, boolean modal, Nodo raiz, String nombreAEliminar)
    {
        super(parent, modal);
        initComponents();
        this.raiz = raiz;
