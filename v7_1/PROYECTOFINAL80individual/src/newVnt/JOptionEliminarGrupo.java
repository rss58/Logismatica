 ...
 */
public class JOptionEliminarGrupo extends java.awt.Dialog implements ActionListener
{
     ...
     */
    public JOptionEliminarGrupo(java.awt.Frame parent, boolean modal, Nodo raiz)
    {
        super(parent, modal);
        initComponents();
        ...
        while (aux != null)
        {
            System.out.println("raiz: " + aux.getEtq().toString());
            creaIzquierda(aux.getEtq().toString());
            aux = aux.getSig();
        }
    }
    ...
    private void initComponents()
    {
        ...
        jLInformacion.setText("Grupo(s) a eliminar");
    ...
    {//GEN-HEADEREND:event_btnEliminarActionPerformed
        ...
        for (int i = 0; i < s.length; i++)
        {
            ...
            AlertaAlEliminarGrupo a = new AlertaAlEliminarGrupo(this.paren, true, raiz, s[i]);
            a.setVisible(true);
            if (a.isConfirmarEli())
            {
